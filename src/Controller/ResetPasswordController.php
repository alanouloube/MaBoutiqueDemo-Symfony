    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                $content = "Bonjour " . $user->getFirstname() . "<br/>Vous avez demandé à réinitialiser votre mot de passe sur le site Ma Boutique Demo.<br/><br/>";

                $content .= "Merci de bien vouloir cliquer sur le lien suivant pour <a href='{$url}'>mettre à jour votre mot de passe</a>. ou en copier le lien suivant : <br><br> {$url}<br><br>";




                $mail = new Mail();
                $mail->send($user->getEmail(), $user->getFirstname() . ' ' . $user->getLastname(), 'Réinitialiser votre mot de passe sur Ma Boutique Demo', $content);
